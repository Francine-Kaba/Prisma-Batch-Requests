...
SCHEMA_PATH = Path('C:/Users/Francine-MariaAwezig/PythonProjects/Prisma-Batch-Requests/schema.prisma')
...
class Prisma:
    ...
    audit_log: 'actions.audit_logActions'
    ...
    def __init__(
        ...
        *,
        ...
        self.audit_log = actions.audit_logActions(self, models.audit_log)
...
class Batch:
    ...
    audit_log: 'audit_logBatchActions'
    ...
    def __init__(self, client: Prisma) -> None:
        ...
        self.audit_log = audit_logBatchActions(self)
...
# NOTE: some arguments are meaningless in this context but are included
# for completeness sake
class audit_logBatchActions:
    def __init__(self, batcher: Batch) -> None:
        self._batcher = batcher

    def create(
        self,
        data: types.audit_logCreateInput,
        include: Optional[types.audit_logInclude] = None
    ) -> None:
        self._batcher._add(
            operation='mutation',
            method='createOne',
    ...
    def create_many(
        self,
        data: List[types.audit_logCreateWithoutRelationsInput],
        *,
        skip_duplicates: Optional[bool] = None,
    ) -> None:
        if self._batcher._active_provider == 'sqlite':
    ...
    def delete(
        self,
        where: types.audit_logWhereUniqueInput,
        include: Optional[types.audit_logInclude] = None,
    ) -> None:
        self._batcher._add(
            operation='mutation',
    ...
    def update(
        self,
        data: types.audit_logUpdateInput,
        where: types.audit_logWhereUniqueInput,
        include: Optional[types.audit_logInclude] = None
    ) -> None:
        self._batcher._add(
    ...
    def upsert(
        self,
        where: types.audit_logWhereUniqueInput,
        data: types.audit_logUpsertInput,
        include: Optional[types.audit_logInclude] = None,
    ) -> None:
        self._batcher._add(
            operation='mutation',
    ...
    def update_many(
        self,
        data: types.audit_logUpdateManyMutationInput,
        where: types.audit_logWhereInput,
    ) -> None:
        self._batcher._add(
            operation='mutation',
            method='updateMany',
    ...
    def delete_many(
        self,
        where: Optional[types.audit_logWhereInput] = None,
    ) -> None:
        self._batcher._add(
            operation='mutation',
            method='deleteMany',
